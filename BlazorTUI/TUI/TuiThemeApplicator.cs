namespace BlazorTUI.TUI
{
    internal static class TuiThemeApplicator
    {
        ...
        private static TuiThemeRole GetDefaultRole(Control control)
            => control switch
            {
                TextBox or PasswordBox or TextArea or NumericBox or DateBox or DatePicker or DateRangePicker or MonthPicker or TimeBox or ComboBox or ListBox => TuiThemeRole.Input,
